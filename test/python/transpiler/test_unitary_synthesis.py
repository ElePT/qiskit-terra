...
from qiskit.providers.fake_provider import Fake5QV1, FakeMumbaiFractionalCX, FakeGeneric
...
class TestUnitarySynthesis(QiskitTestCase):
    ...
    def test_single_qubit_with_target(self):
        ...
        dag = circuit_to_dag(qc)
        unitary_synth_pass = UnitarySynthesis(target=FakeGeneric(num_qubits=5).target)
