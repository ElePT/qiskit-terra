...
from qiskit.providers.fake_provider import Fake65QV1Pulse, FakeGeneric
...
class TestPulseGate(QiskitTestCase):
    ...
    def test_transpile_with_instmap(self):
        ...
        instmap = Fake65QV1Pulse().defaults().instruction_schedule_map
    ...
    def test_transpile_with_both_instmap_and_empty_target(self, opt_level):
        ...
        # Save instruction map with additional custom schedule
        instmap = target.instruction_schedule_map()
        instmap.add("sx", (0,), self.custom_sx_q0)
        instmap.add("sx", (1,), self.custom_sx_q1)
