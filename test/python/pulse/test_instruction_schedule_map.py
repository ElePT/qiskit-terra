...
from qiskit.providers.fake_provider import FakeOpenPulse2Q, Fake7QV1Pulse
...
class TestInstructionScheduleMap(QiskitTestCase):
    ...
    def test_two_instmaps_equal(self):
        ...
        instmap1 = Fake7QV1Pulse().defaults().instruction_schedule_map
    ...
    def test_instmap_picklable(self):
        ...
        instmap = Fake7QV1Pulse().defaults().instruction_schedule_map
