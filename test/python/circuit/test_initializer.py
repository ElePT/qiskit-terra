...
class TestInitialize(QiskitTestCase):
    ...
    def test_uniform_superposition(self):
        ...
        job = execute(qc, TestProvider.get_backend("statevector_simulator"))
        result = job.result()
    ...
    def test_initialize_one_by_one(self):
        ...
        job = execute([qc_a, qc_b], TestProvider.get_backend("statevector_simulator"))
        result = job.result()
    ...
    def test_initialize_middle_circuit(self):
        ...
        job = execute(qc, TestProvider.get_backend("qasm_simulator"), shots=shots, seed_simulator=42)
        result = job.result()
    ...
    def test_combiner(self):
        ...
        job = execute(qc1.compose(qc2), TestProvider.get_backend("statevector_simulator"))
        result = job.result()
